...
export default function HeroSection() {
    return (
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden px-6 lg:px-12 pt-16 bg-zinc-50 dark:bg-zinc-950 transition-colors duration-500">
            {/* Aurora Background */}
            <div className="absolute inset-0 -z-10 pointer-events-none overflow-hidden">
                <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] rounded-full bg-purple-500/10 blur-[100px] mix-blend-multiply dark:mix-blend-screen animate-pulse" style={{ animationDuration: '4s' }} />
                <div className="absolute top-[20%] right-[-5%] w-[40%] h-[40%] rounded-full bg-blue-500/10 blur-[100px] mix-blend-multiply dark:mix-blend-screen animate-pulse" style={{ animationDuration: '6s', animationDelay: '1s' }} />
                <div className="absolute bottom-[-10%] left-[20%] w-[60%] h-[60%] rounded-full bg-indigo-500/10 blur-[100px] mix-blend-multiply dark:mix-blend-screen animate-pulse" style={{ animationDuration: '5s', animationDelay: '2s' }} />
            </div>
            ...
            <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                >
                    <motion.div
                        ...
                        className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-zinc-200 dark:border-white/10 bg-white/50 dark:bg-white/5 backdrop-blur-md shadow-sm"
                    >
                        <Sparkles className="w-4 h-4 text-purple-500 dark:text-purple-400" />
                        <span className="text-sm font-medium text-zinc-900 dark:text-zinc-300">New Age Storytelling</span>
                    </motion.div>

                    <div className="space-y-3">
                        <motion.h1
                            variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0, transition: { type: "spring", stiffness: 300, damping: 30 } } }}
                            className="text-5xl lg:text-7xl font-bold tracking-tighter text-zinc-900 dark:text-white leading-[1.1]"
                        >
                            Read the <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-cyan-600 dark:from-purple-400 dark:to-cyan-400">Impossible.</span>
                        </motion.h1>
                        <motion.p
                            variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0, transition: { type: "spring", stiffness: 300, damping: 30 } } }}
                    ...
                    >
                        <div className="relative group">
                            ...
                            <button className="relative px-8 py-3.5 rounded-xl bg-zinc-900 dark:bg-zinc-950 text-white font-semibold border border-transparent dark:border-white/10 hover:bg-zinc-800 dark:hover:bg-zinc-900 transition-all flex items-center gap-2 shadow-xl">
                                Start Reading
                            </button>
                        </div>
                        <button className="px-8 py-3.5 rounded-xl border border-zinc-200 dark:border-white/10 bg-white/50 dark:bg-white/5 backdrop-blur-md text-zinc-700 dark:text-zinc-300 font-medium hover:bg-zinc-100 dark:hover:bg-white/10 transition shadow-sm">
                            Explore Genres
                        </button>
                    </motion.div>
                </motion.div>
